...
Column(
   ...
   val image = painterResource(id = R.drawable.profile)
    Image(painter = image, contentDescription = null, modifier = Modifier
        .height(120.dp)
        .width(150.dp))
    Text(text = stringResource(R.string.name_surname), fontSize = 30.sp, color = Color.White)
    Text(text = stringResource(R.string.business),color = Color(0xFFFFC107))
  ...
  Column(
      ...
      Row(
          ...
          Icon(painter = icon, contentDescription = null, modifier = Modifier.padding(start = 60.dp), Color(
              0xFFFFC107
          )
          )
      ...
      Row(
          ...
          Icon(painter = icon2, contentDescription = null,  modifier = Modifier.padding(start = 60.dp),Color(
              0xFFFFC107
          )
          )
      ...
      Row(
        ...
        val icon3 = painterResource(id = R.drawable.ic_baseline_share_24)
          Icon(painter = icon3, contentDescription = null, modifier = Modifier.padding(start = 60.dp),Color(
              0xFFFFC107
          )
          )
